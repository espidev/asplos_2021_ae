...
public:
  __noinline__ __device__ virtual void BaseinitBody(int idx) {classType = 0 ;}
  ...
  ALL  float BaseVelX() {return 0;}
  ALL  float BaseVelY() {return 0;}
  ALL  float BasePosX() { return 0 ; }
  ALL  float BasePosY() { return 0 ;}
  ALL  void  Baseset_VelX(float v) {}
  ALL  void  Baseset_VelY(float v) {}
  ALL  void  Baseset_PosX(float v) {}
  ALL  void  Baseset_PosY(float v) {}
  ALL  void  BaseinitForce() {}
  ALL  void  BaseupdateForceX(BodyType *other, float F) {}
  ALL  void  BaseupdateForceY(BodyType *other, float F) {}
  ALL  bool  Baseactive() { return false;}
  ALL  void  Baseset_active(bool cond) {}
  ALL  float Baseget_mass() { return 0 ; }
  ALL  void  Baseset_mass(float) {}
  ALL  bool  Baseget_incoming_merge() { return false;}
  ALL  bool  Baseget_is_successful_merge() {return false;}
  ALL  IndexT Baseget_merge_target() {return 0;}
  ALL  void  Baseset_incoming_merge(bool cond) {}
  ALL  void  Baseset_is_successful_merge(bool cond) {}
  ALL  void  Baseset_merge_target(IndexT idx) {}

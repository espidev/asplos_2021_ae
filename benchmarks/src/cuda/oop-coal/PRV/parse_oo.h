...
template <typename VertexValue, typename EdgeValue> class VirtVertex {
public:
  // operation functions
  ...
  ALL virtual void setOutEdge(VirtVertex<float, float> **vertex, int src, int idx,
                              int vertexId, EdgeValue value) = 0;
